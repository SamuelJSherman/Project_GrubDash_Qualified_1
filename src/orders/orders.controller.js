...
module.exports = {
  list,
  create: [deliverToExists, deliverToIsValid, mobileNumberExists, mobileNumberIsValid, dishesExists, dishesIsValid, quantityExists, create],
  read: [orderExists, read],
  update: [orderExists, idsMatch, deliverToExists, deliverToIsValid, mobileNumberExists, mobileNumberIsValid, deliveryStatus, statusExists, dishesExists, dishesIsValid, quantityExists, update],
